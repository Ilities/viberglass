...
const githubPlugin: IntegrationPlugin<GitHubConfig> = {
  ...
  configFields: [
    { key: 'owner', label: 'Repository Owner', type: 'string', required: true, description: 'GitHub organization or user name.' },
    { key: 'repo', label: 'Repository Name', type: 'string', required: true, description: 'Repository slug without the owner.' },
