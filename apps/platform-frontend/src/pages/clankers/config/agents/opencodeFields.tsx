  ...
  return (
    <>
      <Field>
        ...
        <Description>
          Optional OpenAI-compatible endpoint override for this agent runner. If blank, OpenCode uses its default provider
      ...
      <Field>
        ...
        <Description>
          Optional model override for this agent runner. Use <code>provider/model</code> format (e.g.,{' '}
