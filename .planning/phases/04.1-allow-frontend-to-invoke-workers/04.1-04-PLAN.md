...
<task type="auto">
  <name>Task 1: Create job detail page</name>
  <files>
    platform/frontend/src/app/(app)/project/[project]/jobs/[jobId]/page.tsx
  </files>
  <action>
        ...
        <>
          ...
          <div className="mt-8 flex items-start justify-between">
            ...
            <div className="flex gap-2">
              ...
              <Button onClick={() => window.location.reload()} plain>
                Refresh
              </Button>
            </div>
          </div>
    ...
    - Manual refresh button (per CONTEXT.md - no auto-polling)
  ...
  <done>
    ...
    Manual refresh available (no auto-polling per phase scope).
  </done>
</task>
...
3. Page loads for valid job ID
4. Invalid job ID shows 404
5. All job statuses display correctly (queued, active, completed, failed)
6. PR link visible for completed jobs with pullRequestUrl
7. Error message visible for failed jobs
8. Refresh button reloads page
</verification>
