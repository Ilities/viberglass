  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      const ticketData: CreateTicketRequest = {
        ...
        ticketSystem: project.ticketSystem,
        metadata: {
      ...
      router.push(`/project/${projectSlug}/tickets/${ticket.id}`)
    } catch (err: any) {
      ...
      <Fieldset className="mt-8">
        <FieldGroup>
          ...
          <div className="flex justify-end gap-4 border-t border-zinc-950/10 pt-8 dark:border-white/10">
            <Button outline href={`/project/${projectSlug}/tickets`}>
              Cancel
            </Button>
            <Button type="submit" color="brand" disabled={isSubmitting || !project}>
