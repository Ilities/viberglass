...
export default function SettingsLayout({
  ...
  const settingsNavigation = [
    { name: 'Widget', href: `/${project}/settings/widget` },
    { name: 'AI Agent', href: `/${project}/settings/ai` },
    { name: 'Ticketing', href: `/${project}/settings/ticketing` },
    { name: 'Webhooks', href: `/${project}/settings/webhooks` },
  ]
